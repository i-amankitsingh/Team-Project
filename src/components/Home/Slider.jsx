        ...
        <>
            <section className="w-full flex justify-center items-center gap-10 py-5 px-10">
                <div className="lg:w-auto w-full">
                    <h2 className="text-4xl font-bold flex align-middle ">Hello <span className="block ml-5 w-1/2 overflow-hidden">_______________________</span></h2>
                    ...
                    <div className="my-4">
                        ...
                        <a href="My CV.pdf" download><button className="border border-custom-purple border-2 py-3 px-10 ml-3 rounded bg-gradient-to-r hover:from-custom-purple hover:to-custom-blue hover:text-white transition-colors duration-500">GET CV</button></a>
                    </div>
                </div>
